export const CREATE_PHASE_PROMPT_OLD = 
`
...
1. **Gather Context**  
   ...
   - Ideal Steps:
      - Start by searching the codebase for keywords related to the feature (e.g., “auth”, “reset”, “notifications”).
      - Open and read through the most relevant files to understand how things are currently implemented.
      - Inspect utility functions or services that might help (e.g., mailers, logging, background jobs).
      - You can use multiple tools and you should, before rushing for a response.
